...
public class ObjectFactory {
    ...
    private static final QName _Convert_QNAME = new QName("http://ws.enset/", "Convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://ws.enset/", "ConvertResponse");
    private static final QName _ListComptes_QNAME = new QName("http://ws.enset/", "ListComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://ws.enset/", "ListComptesResponse");
    private static final QName _GetCompte_QNAME = new QName("http://ws.enset/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://ws.enset/", "getCompteResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset/", name = "ListComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset/", name = "ListComptesResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset/", name = "getCompteResponse")
